...
object NetworkModule {
    @Singleton
    @Provides
    fun provideHttpLoggerIntercepter(): HttpLoggingInterceptor{
    ...
    //neden network module oluşturuyoruz?
    //http isteği attığımızda retrofitle api faktörünü oluşturmamız gerekiyor.
    //bunu bize otomatikleştirecek. yani parametre vermeden otomatik parametre verecek.
}